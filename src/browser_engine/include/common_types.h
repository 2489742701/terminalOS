...
typedef struct {
  ...
  void *(*create_text_input)(Renderer *renderer, const char *value,
                             const char *placeholder, int x, int y, int width,
                             int height);
  // Create multi-line text area
  void *(*create_text_area)(Renderer *renderer, const char *value, int x, int y,
                            int width, int height);
  // Register hyperlink handler for interactive widgets
  void (*register_link_handler)(Renderer *renderer, void *widget,
                                const char *url);
  // Create container
  void *(*create_container)(Renderer *renderer, int x, int y, int width,
                            int height);
  // Set text color
  ...
  void (*set_bg_gradient)(Renderer *renderer, void *widget,
